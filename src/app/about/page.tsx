    ...
    <section className="mb-20">
      ...
      <div className="py-4 px-10 my-16 flex flex-col gap-y-6">
        ...
        <ul className="flex flex-col gap-y-2.5 text-base md:text-xl list-disc ml-5">
          <li>
            <strong className="text-lg md:text-2xl hover:text-[#009f7f] duration-300">
              Green Projects:{" "}
            </strong>
            We support and implement sustainable projects, assisting in credits
            and transactions.
          </li>
          <li>
            <strong className="text-lg md:text-2xl hover:text-[#009f7f] duration-300">
          ...
          <li>
            ...
            We ensure clients comply with evolving climate-related regulations.
          </li>
          <li>
            <strong className="text-lg md:text-2xl hover:text-[#009f7f] duration-300">
              Sustainable Tech:{" "}
            </strong>
            We help clients integrate green technologies into their operations.
          </li>
          <li>
            <strong className="text-lg md:text-2xl hover:text-[#009f7f] duration-300">
              Risk Assesment:{" "}
          ...
          <li>
            ...
            We educate clients and the public about climate change issues and
            solutions.
          </li>
          <li>
            <strong className="text-lg md:text-2xl hover:text-[#009f7f] duration-300">
            ...
            We partner with environmental organizations, research institutions,
          ...
          <li>
            ...
            We assist clients in claiming carbon credits, from registration to
            transaction.
          </li>
          <li>
            <strong className="text-lg md:text-2xl hover:text-[#009f7f] duration-300">
            ...
            We use data and analytics to track progress and improve strategies.
          </li>
          <li>
            <strong className="text-lg md:text-2xl hover:text-[#009f7f] duration-300">
          ...
          <li>
            ...
            We promote policies and practices for sustainability and resilience.
          </li>
        </ul>
      </div>
      <Team />
